...
(herald "NHCR: unified model (UM)" (bound 20) (limit 8000) (algebra diffie-hellman))
...
(defmacro (key_hint11 ltk1 ltk2 ek1 ek2 h1 h2)
  (hash "key" (nh_key1 ltk1 ltk2 h1) (nh_key1 ek1 ek2 h2)))

(defmacro (key_hint12 ltk1 ltk2 ek1 ek2 h1 h2)
  (hash "key" (nh_key1 ltk1 ltk2 h1) (nh_key2 ek1 ek2 h2)))

(defmacro (key_hint21 ltk1 ltk2 ek1 ek2 h1 h2)
  (hash "key" (nh_key2 ltk1 ltk2 h1) (nh_key1 ek1 ek2 h2)))

(defmacro (key_hint22 ltk1 ltk2 ek1 ek2 h1 h2)
  (hash "key" (nh_key2 ltk1 ltk2 h1) (nh_key2 ek1 ek2 h2)))
