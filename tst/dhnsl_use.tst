...
(defskeleton dhnsl
  (vars (n text) (a b name) (x y rndx) (w expt))
  (defstrand init 5 (n n) (a a) (b b) (y y) (x x))
  (defstrand resp 2 (b b) (a a) (x x) (y y))
  (deflistener (exp (gen) (mul x y)))
...
(defskeleton dhnsl
  (vars (n text) (a b b-0 a-0 name) (x expt) (x-0 y y-0 rndx))
  (defstrand init 5 (n n) (a a) (b b) (y y) (x x-0))
  (defstrand resp 2 (b b) (a a) (x x-0) (y y))
...
(defskeleton dhnsl
  (vars (n text) (a b a-0 b-0 name) (x y x-0 rndx))
  (defstrand init 5 (n n) (a a) (b b) (y y) (x x))
  (defstrand resp 2 (b b) (a a) (x x) (y y))
  (deflistener (exp (gen) (mul x y)))
...
(defskeleton dhnsl
  (vars (n text) (a b a-0 b-0 name) (y x x-0 rndx) (w expt))
  (defstrand resp 5 (n n) (b b) (a a) (x x) (y y))
  (defstrand init 3 (a a) (b b) (y y) (x x))
  (defstrand init 5 (n n) (a a-0) (b b-0) (y (mul y x (rec x-0)))
    (x x-0))
...
(defskeleton dhnsl
  (vars (n text) (a b name) (y x rndx) (w expt))
  (defstrand resp 5 (n n) (b b) (a a) (x x) (y y))
  (defstrand init 3 (a a) (b b) (y y) (x x))
  (deflistener (exp (gen) (mul y x)))
...
(defskeleton dhnsl
  (vars (n text) (a b a-0 b-0 name) (x x-0 y rndx))
  (defstrand resp 5 (n n) (b b) (a a) (x x-0) (y y))
  (defstrand init 3 (a a) (b b) (y y) (x x-0))
  (defstrand init 5 (n n) (a a-0) (b b-0) (y (mul (rec x) x-0 y)) (x x))
  ...
  (traces
    ...
    ((send (enc (exp (gen) x) a-0 (pubk b-0)))
      (recv
        (enc (exp (gen) x) (exp (gen) (mul (rec x) x-0 y)) b-0
          (pubk a-0)))
      (send (enc (exp (gen) (mul (rec x) x-0 y)) (pubk b-0)))
      (recv (enc n (exp (gen) (mul x-0 y)))) (send n))
...
(defskeleton dhnsl
  (vars (n text) (a b a-0 b-0 b-1 a-1 name) (x expt)
    (y x-0 x-1 y-0 rndx))
  (defstrand resp 5 (n n) (b b) (a a) (x x-0) (y y))
  (defstrand init 3 (a a) (b b) (y y) (x x-0))
  (defstrand init 5 (n n) (a a-0) (b b-0) (y (mul y x-0 (rec x-1)))
    (x x-1))
  (deflistener (cat (exp (gen) y-0) (mul y x-0 (rec x-1) (rec y-0))))
  (defstrand resp 2 (b b-1) (a a-1) (x x) (y y-0))
  (precedes ((0 1) (1 1)) ((0 1) (3 0)) ((0 3) (2 3)) ((1 0) (0 0))
    ((1 2) (0 2)) ((2 0) (3 0)) ((2 4) (0 4)) ((3 1) (2 1))
    ((4 1) (3 0)))
  (absent (y-0 (exp (gen) x)) (y (exp (gen) x-0)))
  ...
  (traces
    ...
    ((send (enc (exp (gen) x-1) a-0 (pubk b-0)))
      (recv
        (enc (exp (gen) x-1) (exp (gen) (mul y x-0 (rec x-1))) b-0
          (pubk a-0)))
      (send (enc (exp (gen) (mul y x-0 (rec x-1))) (pubk b-0)))
      (recv (enc n (exp (gen) (mul y x-0)))) (send n))
    ((recv (cat (exp (gen) y-0) (mul y x-0 (rec x-1) (rec y-0))))
      (send (cat (exp (gen) y-0) (mul y x-0 (rec x-1) (rec y-0)))))
    ((recv (enc (exp (gen) x) a-1 (pubk b-1)))
      (send (enc (exp (gen) x) (exp (gen) y-0) b-1 (pubk a-1)))))
  (label 48)
  (parent 43)
  (unrealized (2 1) (3 0))
  (dead)
...
(defskeleton dhnsl
  ...
  (defstrand resp 5 (n n) (b b) (a a) (x x-0) (y y))
  (defstrand init 3 (a a) (b b) (y y) (x x-0))
  (defstrand init 5 (n n) (a a-0) (b b-0) (y (mul y (rec x) x-0)) (x x))
...
(defskeleton dhnsl
  (vars (n text) (a b a-0 b-0 a-1 b-1 name) (y x x-0 x-1 rndx))
  (defstrand resp 5 (n n) (b b) (a a) (x x) (y y))
  (defstrand init 3 (a a) (b b) (y y) (x x))
  (defstrand init 5 (n n) (a a-0) (b b-0) (y (mul y x (rec x-0)))
    (x x-0))
...
(defskeleton dhnsl
  (vars (n text) (a b b-0 a-0 name) (x expt) (y x-0 y-0 rndx))
  (defstrand resp 5 (n n) (b b) (a a) (x x-0) (y y))
  (defstrand init 3 (a a) (b b) (y y) (x x-0))
  (deflistener (exp (gen) (mul y x-0)))
  (deflistener (cat (exp (gen) y-0) (mul y x-0 (rec y-0))))
  (defstrand resp 2 (b b-0) (a a-0) (x x) (y y-0))
  (precedes ((0 1) (1 1)) ((0 1) (3 0)) ((1 0) (0 0)) ((1 2) (0 2))
  ...
  (traces
    ...
    ((recv (cat (exp (gen) y-0) (mul y x-0 (rec y-0))))
      (send (cat (exp (gen) y-0) (mul y x-0 (rec y-0)))))
    ((recv (enc (exp (gen) x) a-0 (pubk b-0)))
      (send (enc (exp (gen) x) (exp (gen) y-0) b-0 (pubk a-0)))))
  (label 54)
  (parent 44)
...
(defskeleton dhnsl
  ...
  (defstrand resp 5 (n n) (b b) (a a) (x x-0) (y y))
  (defstrand init 3 (a a) (b b) (y y) (x x-0))
  (defstrand init 5 (n n) (a a-0) (b b-0) (y (mul (rec x) y x-0)) (x x))
  (deflistener (cat (exp (gen) y) (mul (rec x) x-0)))
...
(defskeleton dhnsl
  (vars (n text) (a b a-0 b-0 name) (y x y-0 x-0 rndx))
  (defstrand resp 5 (n n) (b b) (a a) (x x-0) (y y))
  (defstrand init 3 (a a) (b b) (y y) (x x-0))
  (defstrand init 5 (n n) (a a-0) (b b-0) (y (mul y (rec x) x-0)) (x x))
  (deflistener (cat (exp (gen) x-0) (mul y (rec x))))
...
(defskeleton dhns
  (vars (n text) (a b b-0 a-0 b-1 name) (y x x-0 rndx) (w expt))
  (defstrand resp 5 (n n) (b b) (a a) (x x) (y y))
  (defstrand init 3 (a a) (b b-0) (y y) (x x))
  (defstrand init 5 (n n) (a a-0) (b b-1) (y (mul y x (rec x-0)))
    (x x-0))
...
(defskeleton dhns
  (vars (n text) (a b b-0 name) (y x rndx) (w expt))
  (defstrand resp 5 (n n) (b b) (a a) (x x) (y y))
  (defstrand init 3 (a a) (b b-0) (y y) (x x))
  (deflistener (exp (gen) (mul y x)))
  (deflistener (cat (exp (gen) (mul y x (rec w))) w))
...
(defskeleton dhns
  (vars (n text) (a b b-0 a-0 b-1 name) (x x-0 y rndx))
  (defstrand resp 5 (n n) (b b) (a a) (x x-0) (y y))
  (defstrand init 3 (a a) (b b-0) (y y) (x x-0))
  (defstrand init 5 (n n) (a a-0) (b b-1) (y (mul (rec x) x-0 y)) (x x))
  (deflistener (cat (exp (gen) y) (mul (rec x) x-0)))
  (precedes ((0 1) (1 1)) ((0 1) (3 0)) ((0 3) (2 3)) ((1 0) (0 0))
    ((1 2) (0 2)) ((2 0) (3 0)) ((2 4) (0 4)) ((3 1) (2 1)))
  (absent (y (exp (gen) x-0)))
  ...
  (traces
    ...
    ((send (enc (exp (gen) x) a-0 (pubk b-1)))
      (recv
        (enc (exp (gen) x) (exp (gen) (mul (rec x) x-0 y)) (pubk a-0)))
      (send (enc (exp (gen) (mul (rec x) x-0 y)) (pubk b-1)))
      (recv (enc n (exp (gen) (mul x-0 y)))) (send n))
    ((recv (cat (exp (gen) y) (mul (rec x) x-0)))
      (send (cat (exp (gen) y) (mul (rec x) x-0)))))
  (label 106)
...
(defskeleton dhns
  (vars (n text) (a b b-0 a-0 b-1 b-2 a-1 name) (x expt)
    (y x-0 x-1 y-0 rndx))
  (defstrand resp 5 (n n) (b b) (a a) (x x-0) (y y))
  (defstrand init 3 (a a) (b b-0) (y y) (x x-0))
  (defstrand init 5 (n n) (a a-0) (b b-1) (y (mul y x-0 (rec x-1)))
    (x x-1))
  (deflistener (cat (exp (gen) y-0) (mul y x-0 (rec x-1) (rec y-0))))
  (defstrand resp 2 (b b-2) (a a-1) (x x) (y y-0))
  (precedes ((0 1) (1 1)) ((0 1) (3 0)) ((0 3) (2 3)) ((1 0) (0 0))
    ((1 2) (0 2)) ((2 0) (3 0)) ((2 4) (0 4)) ((3 1) (2 1))
    ((4 1) (3 0)))
  (absent (y-0 (exp (gen) x)) (y (exp (gen) x-0)))
  ...
  (traces
    ...
    ((send (enc (exp (gen) x-0) a (pubk b-0)))
      (recv (enc (exp (gen) x-0) (exp (gen) y) (pubk a)))
      (send (enc (exp (gen) y) (pubk b-0))))
    ((send (enc (exp (gen) x-1) a-0 (pubk b-1)))
      (recv
        (enc (exp (gen) x-1) (exp (gen) (mul y x-0 (rec x-1)))
          (pubk a-0)))
      (send (enc (exp (gen) (mul y x-0 (rec x-1))) (pubk b-1)))
      (recv (enc n (exp (gen) (mul y x-0)))) (send n))
    ((recv (cat (exp (gen) y-0) (mul y x-0 (rec x-1) (rec y-0))))
      (send (cat (exp (gen) y-0) (mul y x-0 (rec x-1) (rec y-0)))))
    ((recv (enc (exp (gen) x) a-1 (pubk b-2)))
      (send (enc (exp (gen) x) (exp (gen) y-0) (pubk a-1)))))
  (label 107)
  (parent 102)
  (unrealized (2 1) (3 0))
  (dead)
...
(defskeleton dhns
  ...
  (defstrand resp 5 (n n) (b b) (a a) (x x-0) (y y))
  (defstrand init 3 (a a) (b b-0) (y y) (x x-0))
  (defstrand init 5 (n n) (a a-0) (b b-1) (y (mul y (rec x) x-0)) (x x))
  (deflistener (cat (exp (gen) x-0) (mul y (rec x))))
  (precedes ((0 1) (1 1)) ((0 1) (3 0)) ((0 3) (2 3)) ((1 0) (0 0))
    ((1 2) (0 2)) ((2 0) (3 0)) ((2 4) (0 4)) ((3 1) (2 1)))
  (absent (y (exp (gen) x-0)))
...
(defskeleton dhns
  (vars (n text) (a b b-0 a-0 b-1 a-1 b-2 name) (y x x-0 x-1 rndx))
  (defstrand resp 5 (n n) (b b) (a a) (x x) (y y))
  (defstrand init 3 (a a) (b b-0) (y y) (x x))
  (defstrand init 5 (n n) (a a-0) (b b-1) (y (mul y x (rec x-0)))
    (x x-0))
...
(defskeleton dhns
  (vars (n text) (a b b-0 name) (x y rndx))
  (defstrand resp 5 (n n) (b b) (a a) (x x) (y y))
  (defstrand init 3 (a a) (b b-0) (y y) (x x))
  (deflistener (exp (gen) (mul x y)))
  (deflistener (cat (exp (gen) y) x))
...
(defskeleton dhns
  (vars (n text) (a b b-0 b-1 a-0 name) (x expt) (y x-0 y-0 rndx))
  (defstrand resp 5 (n n) (b b) (a a) (x x-0) (y y))
  (defstrand init 3 (a a) (b b-0) (y y) (x x-0))
  (deflistener (exp (gen) (mul y x-0)))
  (deflistener (cat (exp (gen) y-0) (mul y x-0 (rec y-0))))
  (defstrand resp 2 (b b-1) (a a-0) (x x) (y y-0))
  (precedes ((0 1) (1 1)) ((0 1) (3 0)) ((1 0) (0 0)) ((1 2) (0 2))
    ((2 1) (0 4)) ((3 1) (2 0)) ((4 1) (3 0)))
  (absent (y-0 (exp (gen) x)) (y (exp (gen) x-0)))
  (non-orig (privk a) (privk b))
  ...
  (traces
    ...
    ((recv (cat (exp (gen) y-0) (mul y x-0 (rec y-0))))
      (send (cat (exp (gen) y-0) (mul y x-0 (rec y-0)))))
    ((recv (enc (exp (gen) x) a-0 (pubk b-1)))
      (send (enc (exp (gen) x) (exp (gen) y-0) (pubk a-0)))))
  (label 113)
  (parent 103)
  (unrealized (2 0) (3 0))
...
(defskeleton dhns
  (vars (n text) (a b b-0 a-0 b-1 name) (x y x-0 rndx))
  (defstrand resp 5 (n n) (b b) (a a) (x x-0) (y y))
  (defstrand init 3 (a a) (b b-0) (y y) (x x-0))
  (defstrand init 5 (n n) (a a-0) (b b-1) (y (mul (rec x) y x-0)) (x x))
  (deflistener (cat (exp (gen) y) (mul (rec x) x-0)))
  (precedes ((0 1) (1 1)) ((0 3) (2 3)) ((1 0) (0 0)) ((1 2) (0 2))
    ((1 2) (3 0)) ((2 0) (3 0)) ((2 4) (0 4)) ((3 1) (2 1)))
  (absent (y (exp (gen) x-0)))
